  ...
  return (
    <>
          ...
          <AnimatedSection>
            <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
              <div className="flex flex-col gap-4">
                <span className="flex size-14 items-center justify-center rounded-2xl bg-burgundy-600 text-white">
      ...
      <section className="bg-ink-50 py-16 sm:py-20">
        <Container>
          <AnimatedSection>
            <div className="relative overflow-hidden rounded-3xl bg-burgundy-600 p-10 text-center text-white sm:p-16">
              <Spotlight />
